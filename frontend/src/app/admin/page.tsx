...
export default function AdminPage() {
  ...
  const fetchGameStats = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE}/api/admin/game-stats`);
      if (response.ok) {
  ...
  const handleSubmitQuestion = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE}/api/admin/next-question`, {
        method: 'POST',
        headers: {
  ...
  const handleResetGame = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE}/api/admin/reset-game`, {
        method: 'POST',
      });
